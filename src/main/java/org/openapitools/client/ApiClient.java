...
public class ApiClient {
    ...
    private String basePath = "http://amber.boonlogic.com/v1";
    private String oauthPath = "http://amber.boonlogic.com/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("authorize-amber-pool", new ApiKeyAuth("header", "Authorization"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://amber.boonlogic.com/v1)
	...
	/**
	 * @param oauthPath the oauthPath to set (e.g http://amber.boonlogic.com/v1)
	 * @return An instance of OkHttpClient
	 */
	public ApiClient setOauthPath(String oauthPath) {
