...
public class StreamStatus {
  ...
  **/
  ...
  public StreamStatus progress(Integer progress) {
  ...
  **/
  ...
  public StreamStatus clusterCount(Integer clusterCount) {
  ...
  **/
  ...
  public StreamStatus retryCount(Integer retryCount) {
  ...
  **/
  ...
  public StreamStatus streamingWindowSize(Integer streamingWindowSize) {
  ...
  **/
  ...
  public StreamStatus totalInferences(Integer totalInferences) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to StreamStatus
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!StreamStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamStatus is not found in the empty JSON string", StreamStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!StreamStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamStatus` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StreamStatus.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamStatus>() {
           @Override
           public void write(JsonWriter out, StreamStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamStatus read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of StreamStatus given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of StreamStatus
  * @throws IOException if the JSON string is invalid with respect to StreamStatus
  */
  public static StreamStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamStatus.class);
  }

 /**
  * Convert an instance of StreamStatus to an JSON string
  *
  * @return JSON string
  */
