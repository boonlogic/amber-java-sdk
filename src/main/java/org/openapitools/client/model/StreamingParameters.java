...
public class StreamingParameters {
  ...
  public StreamingParameters anomalyHistoryWindow(Integer anomalyHistoryWindow) {
  ...
  **/
  ...
  public StreamingParameters learningRateNumerator(Integer learningRateNumerator) {
  ...
  **/
  ...
  public StreamingParameters learningRateDenominator(Integer learningRateDenominator) {
  ...
  **/
  ...
  public StreamingParameters learningMaxClusters(Integer learningMaxClusters) {
  ...
  **/
  ...
  public StreamingParameters learningMaxSamples(Integer learningMaxSamples) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to StreamingParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!StreamingParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamingParameters is not found in the empty JSON string", StreamingParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!StreamingParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamingParameters` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamingParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamingParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamingParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamingParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamingParameters>() {
           @Override
           public void write(JsonWriter out, StreamingParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamingParameters read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of StreamingParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of StreamingParameters
  * @throws IOException if the JSON string is invalid with respect to StreamingParameters
  */
  public static StreamingParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamingParameters.class);
  }

 /**
  * Convert an instance of StreamingParameters to an JSON string
  *
  * @return JSON string
  */
