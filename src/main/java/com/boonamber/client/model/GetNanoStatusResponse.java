...
import com.boonamber.client.model.AmberState;
...
public class GetNanoStatusResponse {
  ...
  public GetNanoStatusResponse() {
  }

  public GetNanoStatusResponse pca(List<List<Float>> pca) {
    
    this.pca = pca;
    return this;
  }

  public GetNanoStatusResponse addPcaItem(List<Float> pcaItem) {
    if (this.pca == null) {
  ...
  **/
  ...
  public GetNanoStatusResponse clusterGrowth(List<BigDecimal> clusterGrowth) {
    
    this.clusterGrowth = clusterGrowth;
    return this;
  }

  public GetNanoStatusResponse addClusterGrowthItem(BigDecimal clusterGrowthItem) {
  ...
  **/
  ...
  public GetNanoStatusResponse clusterSizes(List<BigDecimal> clusterSizes) {
    
    this.clusterSizes = clusterSizes;
    return this;
  }

  public GetNanoStatusResponse addClusterSizesItem(BigDecimal clusterSizesItem) {
  ...
  **/
  ...
  public GetNanoStatusResponse anomalyIndexes(List<BigDecimal> anomalyIndexes) {
    
    this.anomalyIndexes = anomalyIndexes;
    return this;
  }

  public GetNanoStatusResponse addAnomalyIndexesItem(BigDecimal anomalyIndexesItem) {
  ...
  **/
  ...
  public GetNanoStatusResponse frequencyIndexes(List<BigDecimal> frequencyIndexes) {
    
    this.frequencyIndexes = frequencyIndexes;
    return this;
  }

  public GetNanoStatusResponse addFrequencyIndexesItem(BigDecimal frequencyIndexesItem) {
  ...
  **/
  ...
  public GetNanoStatusResponse distanceIndexes(List<BigDecimal> distanceIndexes) {
    
    this.distanceIndexes = distanceIndexes;
    return this;
  }

  public GetNanoStatusResponse addDistanceIndexesItem(BigDecimal distanceIndexesItem) {
  ...
  **/
  ...
  public GetNanoStatusResponse sampleCount(Integer sampleCount) {
  ...
  **/
  ...
  public GetNanoStatusResponse clusterCount(Integer clusterCount) {
  ...
  **/
  ...
  public GetNanoStatusResponse anomalyThreshold(Integer anomalyThreshold) {
  ...
  **/
  ...
  public GetNanoStatusResponse state(AmberState state) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetNanoStatusResponse getNanoStatusResponse = (GetNanoStatusResponse) o;
    return Objects.equals(this.pca, getNanoStatusResponse.pca) &&
        Objects.equals(this.clusterGrowth, getNanoStatusResponse.clusterGrowth) &&
        Objects.equals(this.clusterSizes, getNanoStatusResponse.clusterSizes) &&
        Objects.equals(this.anomalyIndexes, getNanoStatusResponse.anomalyIndexes) &&
        Objects.equals(this.frequencyIndexes, getNanoStatusResponse.frequencyIndexes) &&
        Objects.equals(this.distanceIndexes, getNanoStatusResponse.distanceIndexes) &&
        Objects.equals(this.sampleCount, getNanoStatusResponse.sampleCount) &&
        Objects.equals(this.clusterCount, getNanoStatusResponse.clusterCount) &&
        Objects.equals(this.anomalyThreshold, getNanoStatusResponse.anomalyThreshold) &&
        Objects.equals(this.state, getNanoStatusResponse.state);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetNanoStatusResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetNanoStatusResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetNanoStatusResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetNanoStatusResponse is not found in the empty JSON string", GetNanoStatusResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetNanoStatusResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetNanoStatusResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetNanoStatusResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetNanoStatusResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetNanoStatusResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetNanoStatusResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetNanoStatusResponse>() {
           @Override
           public void write(JsonWriter out, GetNanoStatusResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetNanoStatusResponse read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GetNanoStatusResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetNanoStatusResponse
  * @throws IOException if the JSON string is invalid with respect to GetNanoStatusResponse
  */
  public static GetNanoStatusResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetNanoStatusResponse.class);
  }

 /**
  * Convert an instance of GetNanoStatusResponse to an JSON string
  *
  * @return JSON string
  */
